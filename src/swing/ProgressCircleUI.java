...
/*
    Tạo một cái vòng tròn loading, copy ở "java swing tips"
 */
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        // 2 dòng dưới là để tạo lại 1 hình tròn mờ mới
        g2.setColor(new Color(60, 60, 60, 50));
        g2.fillOval(0, 0, pro.getWidth(), pro.getHeight());
        // dòng dưới là để cho biết hình đó đang trong trạng thái nào ( đang tải / đã hủy )
